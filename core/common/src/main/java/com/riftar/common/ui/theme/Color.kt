...
val backgroundLight = Color(android.graphics.Color.parseColor("#F6F6F6")) // white-smoke-white
val onBackgroundLight = Color(0xFF262626)
val surfaceLight = Color(0xFFF4FBFA)
val onSurfaceLight = Color(android.graphics.Color.parseColor("#262626")) // Nero grey
...
val backgroundDark = Color(android.graphics.Color.parseColor("#F6F6F6")) // white-smoke-white
val onBackgroundDark = Color(0xFFDDE4E3)
val surfaceDark = Color(android.graphics.Color.parseColor("#262626")) // Nero grey
...
val successLight = Color(0xFF38693C)
